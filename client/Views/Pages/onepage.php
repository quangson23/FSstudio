        ...
        <div class="row">
                ...
                <div class="kenne-blog-sidebar-wrapper">
                    ...
                    <div class="kenne-blog-sidebar">
                        ...
                        <div class="recent-post">
                            <div class="recent-post_thumb">
                                <a href="blog-details.html">
                                    <img class="img-full" src="client/assets/images/blog/1.jpg"
                                        alt="Kenne's Blog Image">
                                </a>
                            </div>
                        ...
                        <div class="recent-post">
                            <div class="recent-post_thumb">
                                <a href="blog-details.html">
                                    <img class="img-full" src="client/assets/images/blog/2.jpg"
                                        alt="Kenne's Blog Image">
                                </a>
                            </div>
                            <div class="recent-post_desc">
                        ...
                        <div class="recent-post">
                            <div class="recent-post_thumb">
                                <a href="blog-details.html">
                                    <img class="img-full" src="client/assets/images/blog/3.jpg"
                                        alt="Kenne's Blog Image">
                                </a>
                            </div>
                            <div class="recent-post_desc">
                        ...
                        <div class="recent-post">
                            <div class="recent-post_thumb">
                                <a href="blog-details.html">
                                    <img class="img-full" src="client/assets/images/blog/4.jpg"
                                        alt="Kenne's Blog Image">
                                </a>
                            </div>
                            <div class="recent-post_desc">
                        ...
                        <div class="recent-post">
                            <div class="recent-post_thumb">
                                <a href="blog-details.html">
                                    <img class="img-full" src="client/assets/images/blog/5.jpg"
                                        alt="Kenne's Blog Image">
                                </a>
                            </div>
                            <div class="recent-post_desc">
                    ...
                    <div class="kenne-blog-sidebar">
                        ...
                        <div class="recent-comment">
                            <div class="user-img">
                                <img class="img-full" src="client/assets/images/blog/admin.jpg"
                                    alt="Kenne's Blog Image">
                            </div>
                            <div class="user-info">
                        ...
                        <div class="recent-comment">
                            <div class="user-img">
                                <img class="img-full" src="client/assets/images/blog/user.jpg" alt="Kenne's Blog Image">
                            </div>
                            <div class="user-info">
            ...
            <div class="col-lg-9 order-lg-2 order-1">
                <div class="blog-item">
                    <div class="blog-img">
                        <a href="blog-details.html">
                            <img src="client/assets/images/blog/1.jpg" alt="Blog Image">
                        </a>
                    </div>
                ...
                <div class="blog-additional_information">
                    <p>Aenean et tempor eros, vitae sollicitudin velit. Etiam varius enim nec quam tempor, sed efficitur
                ...
                <div class="blog-additional_information">
                    <p>Suspendisse turpis ipsum, tempus in nulla eu, posuere pharetra nibh. In dignissim vitae lorem non
                        mollis. Praesent pretium tellus in tortor viverra condimentum. Nullam dignissim facilisis nisl,
                        accumsan placerat justo ultricies vel. Vivamus finibus mi a neque pretium, ut convallis dui
                        lacinia. Morbi a rutrum velit. Curabitur sagittis quam quis consectetur mattis. Aenean sit amet
                        quam vel turpis interdum sagittis et eget neque. Nunc ante quam, luctus et neque a, interdum
                        iaculis metus. Aliquam vel ante mattis, placerat orci id, vehicula quam. Suspendisse quis eros
                        cursus, viverra urna sed, commodo mauris. Cras diam arcu, fringilla a sem condimentum, viverra
                        facilisis nunc. Curabitur vitae orci id nulla maximus maximus. Nunc pulvinar sollicitudin
                        molestie.
                    </p>
                </div>
                    ...
                    <ul>
                        <li>
                            <div class="author-avatar">
                                <img src="client/assets/images/blog/user.jpg" alt="User">
                            </div>
                        ...
                        <li class="comment-children">
                            <div class="author-avatar">
                                <img src="client/assets/images/blog/admin.jpg" alt="Admin">
                            </div>
                            <div class="comment-body">
                                <span class="reply-btn"><a href="javascript:void(0)">reply</a></span>
                                ...
                                <div class="col-lg-12">
                                    <div class="comment-btn_wrap f-left">
                                        <div class="kenne-btn-ps_left">
                                            <a class="kenne-btn transparent-btn transparent-btn-2"
