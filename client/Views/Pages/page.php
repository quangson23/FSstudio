        ...
        <div class="row">
                ...
                <div class="kenne-blog-sidebar-wrapper">
                    ...
                    <div class="kenne-blog-sidebar">
                        ...
                        <div class="recent-post">
                            ...
                            <div class="recent-post_desc">
                                <span><a href="index.php?url=onepage">Soluta ad tempore</a></span>
            ...
            <div class="col-lg-9 order-lg-2 order-1">
                <div class="row blog-item_wrap">
                    <div class="col-lg-6">
                        <div class="blog-item">
                            ...
                            <div class="blog-content">
                                <h3 class="heading">
                                    <a href="index.php?url=onepage">Blog Image Post</a>
                                </h3>
                                <p class="short-desc">
                    ...
                    <div class="col-lg-6">
                        <div class="blog-item">
                            <div class="kenne-element-carousel single-blog_slider arrow-style-2 overflow-hidden"
                                data-slick-options='{
                                    "slidesToShow": 1,
                                    "slidesToScroll": 1,
                                    "infinite": false,
                                ...
                                <div class="single-item">
                                    <div class="blog-img">
                                        <a href="blog-details.html">
                                            <img src="client/assets/images/blog/2.jpg" alt="Blog Image">
                                        </a>
                                    </div>
                                </div>
                                <div class="single-item">
                                    <div class="blog-img">
                                        <a href="blog-details.html">
                                            <img src="client/assets/images/blog/3.jpg" alt="Blog Image">
                                        </a>
                                    </div>
                                </div>
                                <div class="single-item">
                    ...
                    <div class="col-lg-6">
                        <div class="blog-item">
                            <div class="blog-img">
                                <a href="blog-details.html">
                                    <img src="client/assets/images/blog/6.jpg" alt="Blog Image">
                                </a>
                            </div>
                            <div class="blog-content">
                                <h3 class="heading">
                    ...
                    <div class="col-lg-6">
                        <div class="blog-item">
                            <div class="ratio ratio-16x9">
                                <iframe
                                    src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/256180869&amp;color=%23ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;show_teaser=true&amp;visual=true">
                                </iframe>
                            </div>
                            <div class="blog-content">
                                <h3 class="heading">
                    ...
                    <div class="col-lg-6">
                        <div class="blog-item">
                            <div class="ratio ratio-16x9">
                                <iframe src="https://www.youtube.com/embed/-lG0kDeuSJk"
